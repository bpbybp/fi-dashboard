...
//
// [노드] 1 · 2 · 3 · 5 · 10 · 20 · 30 · 50 (8개). 전부 KTB_CURVE.grid 의 관측 노드라 보간 없음.
...
/** CRV-1 이 쓰는 만기 노드(년). 전부 KTB_CURVE.grid 에 실재하는 관측 노드. */
export const NODES = [1, 2, 3, 5, 10, 20, 30, 50];

/** 구간 비중 조합 — 인접 3점 [short, mid, long]. */
export const TRIPLES = [[1, 2, 3], [2, 3, 5], [3, 5, 10], [5, 10, 20], [10, 20, 30], [20, 30, 50]];

/** 듀레이션당 기울기 조합 — 인접 2점 [cur, next]. */
export const PAIRS = [[1, 2], [2, 3], [3, 5], [5, 10], [10, 20], [20, 30], [30, 50]];
