...
import { normalizeIssuer } from './rv2-parser.js';
...
// normalizeIssuer 는 파서 계층으로 옮겼다 — 중복제거 키(§1.7)도 같은 정규화를 써야 하기 때문이다.
// 여기서는 재export 만 한다(기존 호출부·테스트 표면 유지).
export { normalizeIssuer };
